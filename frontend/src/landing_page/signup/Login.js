...
const Login = () => {
 ...
 window.location.href = `https://zerodha-project-kscs.vercel.app/?name=${encodeURIComponent(signupName)}`; //https://zerodha-project-9dmm-1zncn9b7v-sufiyan786.vercel.app/
}
  } catch (err) {
